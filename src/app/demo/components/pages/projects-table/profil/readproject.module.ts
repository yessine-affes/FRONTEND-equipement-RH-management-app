...
import {ReadProjectComponent } from './readproject.component';
import { ReadProjectRoutingModule } from './readproject-routing.module';
...
export class ReadProjectModule { }
